...
public class NewAccount {
    ...
    public void deleteAccount(){
        ...
        System.out.println("Hesabı silmek ucun PIN yazin. ");
        while (true){
            ...
            if (this.pin == pin){
                System.out.println(ad + " " + soyad + " adli hesab ugurla silindi. ");
                    ...
                    System.out.println("Girdiyiniz PIN yalnisdir. ");
                }
            }else {
    ...
    public void changePin(){
        ...
        System.out.println("Pin kodu deyismek ucun ad ve soyadinizi yazin: Numune (Eli Eliyev) ");
        Scanner scanner = new Scanner(System.in);
        while (true){
            String adSoyad = scanner.nextLine();
            if(adSoyad.equals(ad+" " + soyad)){
                System.out.println("Ad soyad duzgubdur, yeni PIN yazin. ");
                while (true){
                    if (scanner.hasNextInt()){
                        ...
                        if (yeniPin == pin){
                            ...
                            pin = yeniPin;
                            System.out.println("PIN ugurla yenilendi.");
                            break;
                        }
                        else {
                        ...
                        System.out.println("Pin yalniz reqemlerden ibaret olamlidir.");
                        scanner.next();
                    }
                }
                break;
                ...
                System.out.println("Girdiyiniz ad soyad yalnisdir.");
            }
        }
        waitResponse();
    }
    ...
    public void withdraw() {
        ...
        Scanner scanner = new Scanner(System.in);
        System.out.println("Zehmet olmasa cixaris ucun mebleg yazın: ");
        while (true){
        double money = 0;
    ...
    public void deposit(){
        ...
        Scanner scanner = new Scanner(System.in);
        System.out.println("Zehmet olmasa deposit ucun mebleg yazın: ");
        while (true) {
            double money = 0;
            if (scanner.hasNextDouble()) {
                money = scanner.nextDouble();
    ...
    public void register(){
        ...
        while (true){
            ...
            int pin = scanner.nextInt();
            if (pin<1000 || pin>9999) System.out.println("Girdiyiniz pisn 4 reqemli deyil.");
            else {
                this.pin=pin;
                break;
            }
